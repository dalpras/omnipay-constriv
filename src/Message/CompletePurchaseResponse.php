...
class CompletePurchaseResponse extends \Omnipay\Common\Message\AbstractResponse implements \Omnipay\Common\Message\RedirectResponseInterface {
    ...
    /**
     * Get the payment ID as generated by the gateway.
     * It's available also if the transaction has not been captured.
     *
     * @return string
     */
     ...
     * This tell the gateway to redirect the user to the url specified.
     */
